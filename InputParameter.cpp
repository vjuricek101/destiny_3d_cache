...
InputParameter::InputParameter() {
	...
	minTagNumRowMat = 1;
	maxTagNumRowMat = 512;
	minTagNumColumnMat = 1;
	maxTagNumColumnMat = 512;
	minTagNumActiveMatPerRow = 1;
	maxTagNumActiveMatPerRow = maxTagNumColumnMat;
	minTagNumActiveMatPerColumn = 1;
	maxTagNumActiveMatPerColumn = maxTagNumRowMat;
	minTagNumRowSubarray = 1;
	maxTagNumRowSubarray = 2;
	minTagNumColumnSubarray = 1;
	maxTagNumColumnSubarray = 2;
	minTagNumActiveSubarrayPerRow = 1;
	maxTagNumActiveSubarrayPerRow = maxTagNumColumnSubarray;
	minTagNumActiveSubarrayPerColumn = 1;
	maxTagNumActiveSubarrayPerColumn = maxTagNumRowSubarray;
	minTagMuxSenseAmp = 1;
	maxTagMuxSenseAmp = 256;
	minTagMuxOutputLev1 = 1;
	maxTagMuxOutputLev1 = 256;
	minTagMuxOutputLev2 = 1;
	maxTagMuxOutputLev2 = 256;
	minTagAreaOptimizationLevel = latency_first;
	maxTagAreaOptimizationLevel = area_first;
