// Copyright (c) 2015-2016, UT-Battelle, LLC. See LICENSE file in the top-level
// directory
//  This file contains code from CACTI-3DD, (c) 2012 Hewlett-Packard Development
//  Company, L.P.
...
private:
  void _CalculateLatencyAndPower(double _rampInput, double &_dynamicEnergy,
                                 double &_latency);
};
