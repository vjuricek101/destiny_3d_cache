...
def main():
    parser = argparse.ArgumentParser(
        description="Dense Cartesian architectural sweep for DESTINY (full exploration + pruning)."
    )
    ...
    if args.mini:
        global CAPACITY_SWEEP_KB, WORD_WIDTHS, ASSOCIATIVITIES, STACK_COUNTS, TEMPERATURE_SWEEP
        CAPACITY_SWEEP_KB = [64]
        WORD_WIDTHS = [64]
        ASSOCIATIVITIES = [4]
        STACK_COUNTS = [1]
        TEMPERATURE_SWEEP = [300]
